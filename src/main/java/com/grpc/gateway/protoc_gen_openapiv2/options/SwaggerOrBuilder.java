...
com.grpc.gateway.protoc_gen_openapiv2.options.Response defaultValue);
   ...
   */
  java.util.List<com.grpc.gateway.protoc_gen_openapiv2.options.Tag> 
      getTagsList();
  /**
   * <pre>
   * A list of tags for API documentation control. Tags can be used for logical
   ...
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.Tag tags = 13 [json_name = "tags"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.Tag getTags(int index);
  /**
   * <pre>
   * A list of tags for API documentation control. Tags can be used for logical
   * grouping of operations by resources or any other qualifier.
   ...
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.Tag tags = 13 [json_name = "tags"];</code>
   */
  java.util.List<? extends com.grpc.gateway.protoc_gen_openapiv2.options.TagOrBuilder> 
   ...
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.Tag tags = 13 [json_name = "tags"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.TagOrBuilder getTagsOrBuilder(
      int index);
