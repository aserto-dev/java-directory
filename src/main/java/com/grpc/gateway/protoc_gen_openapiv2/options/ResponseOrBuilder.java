...
public interface ResponseOrBuilder extends
   ...
   * @return The schema.
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.Schema getSchema();
  /**
   * <pre>
   * `Schema` optionally defines the structure of the response.
   * If `Schema` is not provided, it means there is no content to the response.
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.Schema schema = 2 [json_name = "schema"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.SchemaOrBuilder getSchemaOrBuilder();
  ...
  java.util.Map<java.lang.String, com.grpc.gateway.protoc_gen_openapiv2.options.Header>
  getHeaders();
  /**
   * <pre>
   * `Headers` A list of headers that are sent with the response.
...
com.grpc.gateway.protoc_gen_openapiv2.options.Header defaultValue);
   ...
   * <code>map&lt;string, .grpc.gateway.protoc_gen_openapiv2.options.Header&gt; headers = 3 [json_name = "headers"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.Header getHeadersOrThrow(
      java.lang.String key);
