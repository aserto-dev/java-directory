...
public interface SecurityDefinitionsOrBuilder extends
  ...
  java.util.Map<java.lang.String, com.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme>
  getSecurity();
  /**
   * <pre>
   * A single security scheme definition, mapping a "name" to the scheme it
...
com.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme defaultValue);
   ...
   * <code>map&lt;string, .grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme&gt; security = 1 [json_name = "security"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme getSecurityOrThrow(
      java.lang.String key);
}
