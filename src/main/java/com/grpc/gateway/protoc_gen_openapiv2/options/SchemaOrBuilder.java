...
public interface SchemaOrBuilder extends
   ...
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema getJsonSchema();
  /**
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema json_schema = 1 [json_name = "jsonSchema"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.JSONSchemaOrBuilder getJsonSchemaOrBuilder();
