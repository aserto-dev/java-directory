...
public interface JSONSchemaOrBuilder extends
   ...
   */
  java.util.List<com.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes> getTypeList();
  /**
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes type = 35 [json_name = "type"];</code>
   ...
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes getType(int index);
  /**
   * <code>repeated .grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.JSONSchemaSimpleTypes type = 35 [json_name = "type"];</code>
   ...
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.FieldConfiguration getFieldConfiguration();
  /**
   * <pre>
   * Additional field level properties used when generating the OpenAPI v2 file.
   * </pre>
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.FieldConfiguration field_configuration = 1001 [json_name = "fieldConfiguration"];</code>
   */
  com.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.FieldConfigurationOrBuilder getFieldConfigurationOrBuilder();
