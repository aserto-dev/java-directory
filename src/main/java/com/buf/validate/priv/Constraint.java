...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.buf.validate.priv.Constraint)) {
      return super.equals(obj);
    }
    com.buf.validate.priv.Constraint other = (com.buf.validate.priv.Constraint) obj;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.buf.validate.priv.Constraint) {
        return mergeFrom((com.buf.validate.priv.Constraint)other);
      } else {
    ...
    public Builder mergeFrom(com.buf.validate.priv.Constraint other) {
      if (other == com.buf.validate.priv.Constraint.getDefaultInstance()) return this;
