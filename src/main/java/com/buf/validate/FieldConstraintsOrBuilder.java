...
public interface FieldConstraintsOrBuilder extends
   ...
   */
  java.util.List<com.buf.validate.Constraint> 
      getCelList();
  /**
   * <pre>
   * `cel` is a repeated field used to represent a textual expression
   ...
   * <code>repeated .buf.validate.Constraint cel = 23 [json_name = "cel"];</code>
   */
  com.buf.validate.Constraint getCel(int index);
  /**
   * <pre>
   * `cel` is a repeated field used to represent a textual expression
   * in the Common Expression Language (CEL) syntax. For more information on
   ...
   * <code>repeated .buf.validate.Constraint cel = 23 [json_name = "cel"];</code>
   */
  java.util.List<? extends com.buf.validate.ConstraintOrBuilder> 
      getCelOrBuilderList();
  /**
   * <pre>
   * `cel` is a repeated field used to represent a textual expression
   ...
   * <code>repeated .buf.validate.Constraint cel = 23 [json_name = "cel"];</code>
   */
  com.buf.validate.ConstraintOrBuilder getCelOrBuilder(
      int index);
  ...
  com.buf.validate.FieldConstraints.TypeCase getTypeCase();
}
