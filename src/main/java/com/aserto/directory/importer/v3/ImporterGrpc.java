...
@javax.annotation.Generated(
    ...
    comments = "Source: aserto/directory/importer/v3/importer.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ImporterGrpc {

  private ImporterGrpc() {}

  public static final java.lang.String SERVICE_NAME = "aserto.directory.importer.v3.Importer";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.aserto.directory.importer.v3.ImportRequest,
      com.aserto.directory.importer.v3.ImportResponse> getImportMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Import",
      requestType = com.aserto.directory.importer.v3.ImportRequest.class,
      responseType = com.aserto.directory.importer.v3.ImportResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.aserto.directory.importer.v3.ImportRequest,
      com.aserto.directory.importer.v3.ImportResponse> getImportMethod() {
    io.grpc.MethodDescriptor<com.aserto.directory.importer.v3.ImportRequest, com.aserto.directory.importer.v3.ImportResponse> getImportMethod;
      ...
      synchronized (ImporterGrpc.class) {
        if ((getImportMethod = ImporterGrpc.getImportMethod) == null) {
          ImporterGrpc.getImportMethod = getImportMethod =
              io.grpc.MethodDescriptor.<com.aserto.directory.importer.v3.ImportRequest, com.aserto.directory.importer.v3.ImportResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Import"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aserto.directory.importer.v3.ImportRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.aserto.directory.importer.v3.ImportResponse.getDefaultInstance()))
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.aserto.directory.importer.v3.ImportRequest,
              com.aserto.directory.importer.v3.ImportResponse>(
  ...
  private static abstract class ImporterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.aserto.directory.importer.v3.ImporterProto.getDescriptor();
    }
