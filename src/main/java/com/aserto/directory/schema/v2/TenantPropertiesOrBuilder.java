...
@java.lang.Deprecated public interface TenantPropertiesOrBuilder extends
    // @@protoc_insertion_point(interface_extends:aserto.directory.schema.v2.TenantProperties)
   ...
   * @return The kind.
   */
  com.aserto.directory.schema.v2.TenantKind getKind();
   ...
   * @return The account.
   */
  com.aserto.directory.schema.v2.AccountProperties getAccount();
  /**
   * <pre>
   * Additional properties that are only set accounts (personal tenant).
   * </pre>
   ...
   * <code>optional .aserto.directory.schema.v2.AccountProperties account = 4 [json_name = "account"];</code>
   */
  com.aserto.directory.schema.v2.AccountPropertiesOrBuilder getAccountOrBuilder();
}
