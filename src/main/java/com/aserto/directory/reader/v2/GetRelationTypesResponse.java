 ...
 */
@java.lang.Deprecated public final class GetRelationTypesResponse extends
...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 3,
      /* suffix= */ "",
      GetRelationTypesResponse.class.getName());
  }
  // Use GetRelationTypesResponse.newBuilder() to construct.
  private GetRelationTypesResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.aserto.directory.reader.v2.GetRelationTypesResponse)) {
      return super.equals(obj);
    }
    com.aserto.directory.reader.v2.GetRelationTypesResponse other = (com.aserto.directory.reader.v2.GetRelationTypesResponse) obj;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.aserto.directory.reader.v2.GetRelationTypesResponse) {
        return mergeFrom((com.aserto.directory.reader.v2.GetRelationTypesResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.aserto.directory.reader.v2.GetRelationTypesResponse other) {
      if (other == com.aserto.directory.reader.v2.GetRelationTypesResponse.getDefaultInstance()) return this;
      if (resultsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.aserto.directory.common.v2.RelationType m =
                  input.readMessage(
                      com.aserto.directory.common.v2.RelationType.parser(),
                      extensionRegistry);
              if (resultsBuilder_ == null) {
                ensureResultsIsMutable();
                results_.add(m);
