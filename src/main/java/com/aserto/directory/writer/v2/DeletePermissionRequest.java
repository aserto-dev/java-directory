 ...
 */
@java.lang.Deprecated public final class DeletePermissionRequest extends
...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 3,
      /* suffix= */ "",
      DeletePermissionRequest.class.getName());
  }
  // Use DeletePermissionRequest.newBuilder() to construct.
  private DeletePermissionRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.aserto.directory.writer.v2.DeletePermissionRequest)) {
      return super.equals(obj);
    }
    com.aserto.directory.writer.v2.DeletePermissionRequest other = (com.aserto.directory.writer.v2.DeletePermissionRequest) obj;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.aserto.directory.writer.v2.DeletePermissionRequest) {
        return mergeFrom((com.aserto.directory.writer.v2.DeletePermissionRequest)other);
      } else {
    ...
    public Builder mergeFrom(com.aserto.directory.writer.v2.DeletePermissionRequest other) {
      if (other == com.aserto.directory.writer.v2.DeletePermissionRequest.getDefaultInstance()) return this;
      if (other.hasParam()) {
