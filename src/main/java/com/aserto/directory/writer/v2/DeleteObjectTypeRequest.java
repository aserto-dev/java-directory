...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 3,
      /* suffix= */ "",
      DeleteObjectTypeRequest.class.getName());
  }
  // Use DeleteObjectTypeRequest.newBuilder() to construct.
  private DeleteObjectTypeRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.aserto.directory.writer.v2.DeleteObjectTypeRequest)) {
      return super.equals(obj);
    }
    com.aserto.directory.writer.v2.DeleteObjectTypeRequest other = (com.aserto.directory.writer.v2.DeleteObjectTypeRequest) obj;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.aserto.directory.writer.v2.DeleteObjectTypeRequest) {
        return mergeFrom((com.aserto.directory.writer.v2.DeleteObjectTypeRequest)other);
      } else {
    ...
    public Builder mergeFrom(com.aserto.directory.writer.v2.DeleteObjectTypeRequest other) {
      if (other == com.aserto.directory.writer.v2.DeleteObjectTypeRequest.getDefaultInstance()) return this;
      if (other.hasParam()) {
